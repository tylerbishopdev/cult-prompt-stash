  ...
  theme: {
    ...
    extend: {
      boxShadow: {
        ...
        "elevation-dark-two":
          "0px 8px 16px rgba(0, 0, 0, 0.5), 0px 4px 8px rgba(0, 0, 0, 0.4), 0px 2px 4px rgba(0, 0, 0, 0.3), 0px 1px 2px rgba(255, 255, 255, 0.05) inset, 0px 0px 0px 1px rgba(255, 255, 255, 0.03) inset, 0px -2px 4px rgba(0, 0, 0, 0.2) inset, 0px 1px 1px rgba(255, 255, 255, 0.01)",
      },
      colors: {
